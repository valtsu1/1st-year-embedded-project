...
int main()
{
    ...
    for(;;)
    {
        ...
        //vasemmalle
        if((dig.l2 == 1 && dig.l1 == 1 && dig.l3 == 0) || (dig.l2 == 1 && dig.l3 == 0 && dig.l1 == 0) {
            motor_turn(155,100,10);
        }
        
        //oikealle
        if((dig.r2 == 1 && dig.r1 == 1 && dig.r3 == 0) || (dig.r2 == 1 && dig.r1 == 0 && dig.r3 == 0)) {
            motor_turn(100,155,10);
        }
        
        //jyrkkä vasen
        if((dig.l3 == 1 && dig.l2 == 1 && dig.l1 == 0) || (dig.l3 == 1 && dig.l2 == 0 && dig.l1 == 0) {
            motor_turn(155,10,10);
        }
        
        //jyrkkä oikea
        if((dig.r3 == 1 && dig.r2 == 1 && dig.r1 == 0) || (dig.r3 == 1 && dig.r2 == 0 && dig.r1 == 0) {
